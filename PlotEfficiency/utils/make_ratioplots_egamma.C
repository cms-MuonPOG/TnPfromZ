...
TH1F* DividTGraphs(TGraphAsymmErrors* gr1, TGraphAsymmErrors* gr2){
    cout<<"gonna divide"<<endl;

    int nbins = gr1->GetN();
    cout<<"gonna divide 0.5"<<endl;
    double xbins[nbins+1];
    cout<<"gonna divide 0.75"<<endl;

    for(int i = 0;  i < nbins; ++i){
    cout<<"gonna divide 0.85"<<endl;
...
int make_ratioplots_egamma(TString _file, TString _canvas, TString _path1, TString _path2, TString _output, TString _legtext, TString histname, TString _canvas2, TString histname2){
    cout <<"Yeah"<<endl;
    ...
    cout << "The privitives from the canvas are"<< endl;
    c1->GetListOfPrimitives()->ls();
    cout << "I am gonna retrieve "<<histname<< endl;
    cout<< "the canvas 1 name is"<<c1->GetName()<<endl;
    TGraphAsymmErrors* eff1 = (TGraphAsymmErrors*)c1->GetPrimitive(c1->GetName());
    cout<<"yea"<<endl;
    TFile *f2 = TFile::Open(_path2 + _file);
    cout<<"yea2"<<endl;
    TCanvas* c2 = (TCanvas*) f2->Get(_canvas2);
    cout<<"yea3"<<endl;
    cout<< "the canvas 2 name is"<<c2->GetName()<<endl;
    c2->GetListOfPrimitives()->ls();
    cout<< "histname2 is "<<histname2<<endl;
    cout<< "canvas2 is "<<_canvas2<<endl;
    TGraphAsymmErrors* eff2 = (TGraphAsymmErrors*)c2->GetPrimitive(c2->GetName());
    cout<<"name of hist2 is"<< eff2->GetName()<<endl;
    cout<<"yea4"<<endl;
