...
if sample == "mc_ICHEP":
    process.TnP_MuonID = Template.clone(
        InputFileNames = cms.vstring(
            #'../Production/TnPTree_80X_DYLL_M50_MadGraphMLM_part1_skim_NVtxWeights.root',
            #'../Production/TnPTree_80X_DYLL_M50_MadGraphMLM_part2_skim_NVtxWeights.root',
            #'../Production/TnPTree_80X_DYLL_M50_MadGraphMLM_part3_skim_NVtxWeights.root',
            #'../Production/TnPTree_80X_DYLL_M50_MadGraphMLM_part4_skim_NVtxWeights.root',
            #'../Production/TnPTree_80X_DYLL_M50_MadGraphMLM_part5_skim_NVtxWeights.root'
            '../Production/TnPTree_80X_DYLL_M50_MadGraphMLM_allpart_skimv3_NVtxWeights.root',
            ),
        InputTreeName = cms.string("fitter_tree"),
        InputDirectoryName = cms.string("tpTree"),
        OutputFileName = cms.string("TnP_MuonID_%s.root" % scenario),
